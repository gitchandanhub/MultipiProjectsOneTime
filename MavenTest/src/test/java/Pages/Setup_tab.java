...
public class Setup_tab  extends AppDriver 
{
	...
	public Setup_tab()
     ...
     @FindBy(xpath = "//*[@id=\"ctl00_MenuTabNew\"]/ul/li[8]/div/ul/li[1]/span")   WebElement setup1;
   
     
     @FindBy(xpath = "//tbody/tr[@id='RAD_SPLITTER_PANE_TR_ctl00_Menu']/td[@id='ctl00_Menu']/div[@id='RAD_SPLITTER_PANE_CONTENT_ctl00_Menu']/div[2]/div[2]/ul[1]/li[8]/div[1]/ul[1]/li[1]/div[1]/ul[1]/li[1]/a[1]/span[1]")   WebElement warehouse;
    ...
    @FindBy(css = ".rmItem:nth-child(2) .rmText")   WebElement click_filter1;
   ...
   @FindBy(xpath = "//tbody/tr[@id='RAD_SPLITTER_PANE_TR_ctl00_Menu']/td[@id='ctl00_Menu']/div[@id='RAD_SPLITTER_PANE_CONTENT_ctl00_Menu']/div[2]/div[2]/ul[1]/li[8]/div[1]/ul[1]/li[1]/div[1]/ul[1]/li[12]/a[1]/img[1]")   WebElement click_setting_tab;
   ...
   @FindBy(xpath = "//tbody/tr[@id='RAD_SPLITTER_PANE_TR_ctl00_Menu']/td[@id='ctl00_Menu']/div[@id='RAD_SPLITTER_PANE_CONTENT_ctl00_Menu']/div[2]/div[2]/ul[1]/li[8]/div[1]/ul[1]/li[1]/div[1]/ul[1]/li[2]/a[1]/span[1]")   WebElement click_location_bin;
   ...
   @FindBy(xpath = "//tbody/tr[@id='RAD_SPLITTER_PANE_TR_ctl00_Menu']/td[@id='ctl00_Menu']/div[@id='RAD_SPLITTER_PANE_CONTENT_ctl00_Menu']/div[2]/div[2]/ul[1]/li[8]/div[1]/ul[1]/li[1]/div[1]/ul[1]/li[5]/a[1]/img[1]")   WebElement click_user ;
   ...
   @FindBy(xpath = "//tbody/tr[@id='RAD_SPLITTER_PANE_TR_ctl00_Menu']/td[@id='ctl00_Menu']/div[@id='RAD_SPLITTER_PANE_CONTENT_ctl00_Menu']/div[2]/div[2]/ul[1]/li[8]/div[1]/ul[1]/li[1]/div[1]/ul[1]/li[6]/a[1]/img[1]") WebElement click_reason_for_adjsut;
...
@FindBy(xpath = "//tbody/tr[@id='RAD_SPLITTER_PANE_TR_ctl00_Menu']/td[@id='ctl00_Menu']/div[@id='RAD_SPLITTER_PANE_CONTENT_ctl00_Menu']/div[2]/div[2]/ul[1]/li[8]/div[1]/ul[1]/li[1]/div[1]/ul[1]/li[7]/a[1]/span[1]") WebElement click_ship_modes;
...
@FindBy(xpath = "//input[@name='ctl00$ContentPlaceHolder1$txtPriority']") WebElement click_ship_modes_priority;
    ...
    public void Click_setup() throws InterruptedException
     ...
     public void add_warehouse_details_click_save() throws InterruptedException
     {
    	 ...
    	 Random r = new Random();
 		 char unique = (char)(r.nextInt(26) + 'A'); 
 		  cname = ("Pisoftektest" + unique);
    	 
    	 warehouse_name.sendKeys(cname);
     ...
     public void Goto_setting_tab() throws InterruptedException
     {
     ...
     public void click_add_button_location() throws InterruptedException
     {
    	 ...
    	 location_bin_name.sendKeys(cname);
    	 Thread.sleep(2000);
    	 location_pick.click();
     ...
     public void location_filter_and_edit_location() throws InterruptedException
     {
    	 ...
    	 location_filter_textbox.sendKeys(cname);
    	 Thread.sleep(3000);
     ...
     public void click_user_add() throws InterruptedException
     {
    	 ...
    	 Random r = new Random();
 		 char unique = (char)(r.nextInt(26) + 'A'); 
 		  cname = ("Pisoftektest" + unique);
    	 click_operator_details_name.sendKeys(cname);
    	 Thread.sleep(2000);
    	 click_operator_details_password.sendKeys("PIuser");
    	 Thread.sleep(2000);
    	 click_operator_details_login.sendKeys(cname);
    	 Thread.sleep(2000);
     ...
     public void click_user_edit_delete() throws InterruptedException
     {
    	 ...
    	 click_user_filter.sendKeys(cname);
    	 Thread.sleep(2000);

...
public class SOdetails1 extends AppDriver
{
	...
	@FindBy(xpath = "//tbody/tr[2]/td[2]/div[1]/div[1]/div[2]/a[1]/span[1]/span[1]")   WebElement  ok;
	@FindBy(css = ".rmItem:nth-child(2) .rmText")   WebElement  filter1;
      ...
      //  @FindBy(xpath = "//*[@id='SoDetailGrid_ctl00_ctl02_ctl00_cmbItem_DropDown']/div[2]/ul/li["+i+"]")  WebElement itemnumtwo;
        ...
        @FindBy(xpath = "//tbody/tr[@id='RAD_SPLITTER_PANE_TR_ctl00_Menu']/td[@id='ctl00_Menu']/div[@id='RAD_SPLITTER_PANE_CONTENT_ctl00_Menu']/div[2]/div[2]/ul[1]/li[4]/span[1]/span[1]")   WebElement click_pick_pack_ship ;
        @FindBy(xpath = "//tbody/tr[@id='RAD_SPLITTER_PANE_TR_ctl00_Menu']/td[@id='ctl00_Menu']/div[@id='RAD_SPLITTER_PANE_CONTENT_ctl00_Menu']/div[2]/div[2]/ul[1]/li[4]/div[1]/ul[1]/li[1]/a[1]/span[1]")   WebElement click_SO ;
